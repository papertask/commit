package com.interview.iso.view.cropoverlay;
...
import com.interview.iso.view.PhotoViewAttacher;
import com.interview.iso.view.cropoverlay.edge.Edge;
import com.interview.iso.view.cropoverlay.utils.PaintUtil;
...
public class CropOverlayView extends View implements PhotoViewAttacher.IGetImageBounds{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        clipPath.addCircle(rectF.centerX(), rectF.centerY(), rectF.height() / 2.0f, Path.Direction.CW);
